(function () {
  ...
  function initActive () {
    ...
    var active = sessionStorage.getItem('GuoQianxiang')
    ...
    if (active && active == 'true') { //非第一次登录 且是开灯(白色)
      ...
      root.style.setProperty('--mainColor', '#4d6a77' )
  ...
  $('#myRadio').click(function () {
    ...
    if ($('#myRadio').hasClass('active')) { //现在黑色变成白色
      sessionStorage.setItem('GuoQianxiang', true)
      ...
      sessionStorage.setItem('GuoQianxiang', false)
